...
public final class ActivityMyaccountBinding implements ViewBinding {
  ...
  public static ActivityMyaccountBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_myaccount, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityMyaccountBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.backbutton3;
      Button backbutton3 = ViewBindings.findChildViewById(rootView, id);
      if (backbutton3 == null) {
        break missingId;
      }

      return new ActivityMyaccountBinding((ConstraintLayout) rootView, backbutton3);
    }
