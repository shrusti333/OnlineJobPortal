...
public final class UseritemlayoutBinding implements ViewBinding {
  ...
  private UseritemlayoutBinding(@NonNull CardView rootView, @NonNull TextView itemcompanyname,
  ...
  public static UseritemlayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.useritemlayout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static UseritemlayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UseritemlayoutBinding((CardView) rootView, itemcompanyname, itemjobname, itemplace,
